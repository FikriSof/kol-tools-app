    ...
    <header className="flex h-20 items-center justify-between border-b border-slate-200 bg-white px-8">
      ...
      <div className="flex items-center gap-5">
        <Button
          variant="ghost"
          size="icon"
          className="relative text-slate-500 hover:text-slate-700 hover:bg-slate-50 h-10 w-10 rounded-full"
        >
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              className="relative h-10 w-10 rounded-full ring-2 ring-transparent hover:ring-indigo-100 p-0 overflow-hidden bg-slate-900 border border-slate-800 shadow-sm"
            >
          ...
          >
            ...
            <DropdownMenuItem className="text-slate-700 focus:bg-slate-50 focus:text-indigo-600">
              Profile
            </DropdownMenuItem>
            <DropdownMenuItem className="text-slate-700 focus:bg-slate-50 focus:text-indigo-600">
              Settings
