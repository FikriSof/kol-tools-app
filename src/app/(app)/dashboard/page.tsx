      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[15px] text-slate-500 mt-1">
            Overview of your creator unlocks and activity.
          </p>
        </div>
        <Button
          variant="outline"
          className="h-10 px-4 text-slate-700 border-slate-300 font-medium hover:bg-slate-50 shadow-sm rounded-lg flex items-center gap-2"
        >
      ...
      <div className="grid gap-6 md:grid-cols-3 mt-6">
        ...
        <Card className="border-[#4338ca] shadow-sm rounded-xl overflow-hidden pt-6 px-6 pb-6 bg-white ring-1 ring-[#4338ca]">
          <div className="flex flex-col h-full justify-between gap-8">
            ...
            <div>
              <p className="text-[13px] font-semibold text-[#4338ca] uppercase tracking-wider mb-1">
                Total Unlocks
              </p>
              <div className="text-[32px] font-semibold text-slate-900 leading-none">
                8,592
      ...
      <div className="mt-8">
        <Card className="border-slate-200 shadow-sm rounded-xl overflow-hidden bg-white">
          <div className="flex items-center justify-between p-6 border-b border-slate-100">
            ...
            <Button
              variant="ghost"
              className="text-[#4338ca] hover:text-[#3730a3] hover:bg-indigo-50 font-medium px-2 h-auto flex items-center gap-1.5 text-[15px]"
            >
            ...
            <Table>
              <TableHeader className="bg-[#f8fafc]">
                <TableRow className="hover:bg-transparent border-slate-100">
                  <TableHead className="text-slate-500 text-[13px] font-semibold uppercase tracking-wider h-11 pl-6">
                    Creator
                  </TableHead>
                  <TableHead className="text-slate-500 text-[13px] font-semibold uppercase tracking-wider h-11">
                    Agency
                  </TableHead>
                  <TableHead className="text-slate-500 text-[13px] font-semibold uppercase tracking-wider h-11">
                    Date
                  ...
                  <TableHead className="text-slate-500 text-[13px] font-semibold uppercase tracking-wider h-11 text-right pr-6">
                    Action
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {[
                  ...
                  },
                  {
                    ...
                    agency: "NextGen Media",
                    date: "Oct 23, 2023",
                    status: "Pending",
                    statusColor: "bg-[#fff6ed] text-[#c4320a]",
                  },
                  {
                    creator: "Emily Chen",
                    agency: "Independent",
                  ...
                  {
                    creator: "David Kim",
                    agency: "Viral Ventures",
                    date: "Oct 20, 2023",
                    status: "Expired",
                    statusColor: "bg-[#f1f5f9] text-[#475569]",
                  },
                ].map((activity, i) => (
                  <TableRow
                    key={`${activity.creator}-${activity.date}`}
                  ...
                  >
                    <TableCell className="py-4 pl-6">
                      <div className="flex items-center gap-3">
                        <Avatar className="h-10 w-10 border border-slate-200">
                          <AvatarImage
                            src={`https://i.pravatar.cc/150?u=${i + 1}a042581f4e29026704d`}
                    ...
                    <TableCell className="py-4 text-[15px] text-slate-600 font-medium">
                      {activity.agency}
                    </TableCell>
                    <TableCell className="py-4 text-[15px] text-slate-600 font-medium">
                      {activity.date}
                    ...
                    <TableCell className="py-4">
                      <span
                        className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold ${activity.statusColor}`}
                      >
                        {activity.status}
                      </span>
                    </TableCell>
                    <TableCell className="py-4 text-right pr-6">
                      <span className="text-[#4338ca] hover:text-[#3730a3] font-semibold cursor-pointer text-[15px]">
                        View
                      </span>
                    </TableCell>
                  </TableRow>
