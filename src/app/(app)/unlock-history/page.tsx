...
export default function UnlockHistoryPage() {
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-2xl font-bold tracking-tight text-slate-900">Unlock History</h1>
                ...
                <Table>
                    <TableHeader className="bg-slate-50">
                        <TableRow className="border-slate-200 hover:bg-slate-50">
                            ...
                            <TableHead className="text-slate-500 font-medium">Date & Time</TableHead>
                    ...
                    <TableBody>
                        {history.map((item) => (
                            <TableRow key={item.id} className="border-slate-200 hover:bg-slate-50">
                                ...
                                <TableCell className="text-slate-600">{item.platform}</TableCell>
                                <TableCell className="text-slate-600">{item.date}</TableCell>
                                <TableCell className="text-slate-900 font-medium">{item.cost} Credits</TableCell>
                                <TableCell>
